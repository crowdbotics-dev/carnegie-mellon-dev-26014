...
## Project Structure
    ...
    ├── carnegie_mellon_dev_26014  # Django project configurations
...
1. Clone this repo and `cd carnegie_mellon_dev_26014`
...
2. Clone this repo and `cd carnegie_mellon_dev_26014`
